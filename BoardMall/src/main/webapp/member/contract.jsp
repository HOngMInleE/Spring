	...
	<article class="container">
		...
		<form id="join" method="post" name="formm">
			<div class="py-3 text-center">
				...
				회원가입은 무료이며, 가입 즉시 서비스를 이용하실 수 있습니다. 아래의 이용 약관을 반드시 읽고 동의해 주십시오.<br>
				<br>
			</div>
			<hr class="mb-4">
			...
			<br>
			<input type="checkbox" name="agree1"> (필수) 위의 "이용약관"에 동의 합니다. <br>
			<br>
			<br>
			...
			<br>
			<input type="checkbox" name="agree2"> (필수) 위의 "개인정보 수집이용"에 동의
			합니다. <br>
			<br>
			<div class="mb-3 text-center">
				<button class="btn btn-primary btn-lg btn-block" type="submit"
					onclick="go_next()">다음</button>
			</div>
		</form>
	</article>
...
function go_next() {
	...
	}else if (document.formm.agree2.checked == true || document.formm.agree1.checked == true) {
