...
<body>
	...
	%>
			...
			<tr>
				...
				<th width="20%" height="26">작성자</th>
				<th width="20%" height="26">날짜</th>
	...
	%>
				<tr>
					...
					<td width="10%" height="26"><%=bVo.getName()%></td>
					<td width="20%" height="26"><%=bVo.getDate()%></td>
					<td width="10%" height="26"><%=bVo.getReadcount()%></td>
				</tr>
	<%
			}//for
	%>
